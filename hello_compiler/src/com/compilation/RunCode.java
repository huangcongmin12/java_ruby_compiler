...
//			myObj.sayHello();
			...
			while(it.hasNext()){
				...
				String is_success_str = is_success ? "true" : "false";
				String is_error_str = is_success ? "" : name + " failure";
				String is_assets_str = "[{test_description:" + "result:" + is_success + "}]";
						
				retu += name + " -->> "+ "{error:" +is_error_str + " success:" + is_success_str + " assets:" + is_assets_str +  "}";
